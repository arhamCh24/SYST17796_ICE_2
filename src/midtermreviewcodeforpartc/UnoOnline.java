...
public class UnoOnline 
{
    ...
    private void run()
    {
        ...
        String password="";
//        validator.setMinLengthPass(10); // we can change minLength from here
        while(!validPassword)
        {
            System.out.println("Passwords must have at least " + validator.getMinLengthPass()  +" characters");
            System.out.println("Passwords must have at least one special character");
            System.out.println("Please enter your desired password:"); 
            
            password = sc.nextLine();
            
            // calling the isValid method from PasswordValidator Class
